...
public class SubjectClickListener implements RecyclerView.OnItemTouchListener {
    ...
    public SubjectClickListener(Context context, final RecyclerView recyclerView,
